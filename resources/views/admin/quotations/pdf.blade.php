...
<div class="container">
        ...
        <tr>
            ...
            <td style="text-align: right;">
                <h4 class="invoice-title">Cotización
                    <span class="invoice-number">#E{{$quotation->id}}</span>
                </h4>
    ...
    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="py-1">
                                                    <p class="card-text fw-bold mb-25">{{$quotation->producto->name}}</p>
                                                  
                                                </td>
                                                <td class="py-1">
                                                    <span class="fw-bold">{!!$quotation->producto->description!!}</span>
                                                </td>
                                                <td class="py-1">
