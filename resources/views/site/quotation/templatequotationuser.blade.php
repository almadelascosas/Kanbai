					...
					<table width="90%" class="tablealma">
									...
									<table style="width: 90%;">
										<tr>
											<td align="center" style="background-color:#ffffff; font-family: 'Raleway', sans-serif;">
												...
												<br><br>
												Si tienes alguna duda o requieres ayuda de nuestra parte, puedes dar clic al botón para comuncarte con nuestro equipo. {{ $vendedor->name }}
											</td>
										</tr>
									</table>
								</center>
						...
						<tr>
							<td style="text-align: center; vertical-align: middle; background-color:#ffffff;">
								<a class="button-3" href="{{ url('soporte') }}">Contactar</a>
							</td>
						</tr>
						<tr><td colspan="2" style="height:30px;">&nbsp;</td></tr>
						<tr>
									...
									<table width="90%" class="tablealmainterna">
										<tr>
											<td width="30%" style="text-align: center; vertical-align: middle;">
												<img class="imagenpro" src="{{ asset('images/products/'.$producto->gallery[0]->file.'') }}" /> 
											</td>
											<td width="70%" style="vertical-align: top;">
												<span class="titprod">{{ $producto['name'] }}</span>
												<br>
												<span class="txtdetalle">
													Fecha de entrega: <span style="color:#1FD161">{{ $data['fecha'] }}</span>
													<br>
													Cantidad a cotizar: <span style="color:#1FD161">{{ $data['quantity'] }}</span>
												</span>
											</td>
										</tr>
										<tr><td colspan="2" style="height:30px;">&nbsp;</td></tr>
